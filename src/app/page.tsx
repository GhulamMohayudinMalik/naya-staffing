...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-navy-dark flex flex-col font-sans selection:bg-gold selection:text-navy-dark overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-12 py-24">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 pt-12 animate-fade-in-up animate-delay-300">
            ...
            <Link href="/become-a-client" className="text-[11px] font-black uppercase tracking-[0.3em] text-gold/60 hover:text-gold transition-colors sm:ml-6 group text-center whitespace-nowrap">
      ...
      <section className="bg-navy-dark py-20 lg:py-24 2xl:py-32 overflow-hidden border-b border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <section className="bg-navy-dark py-20 lg:py-24 2xl:py-32 border-b border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-24 max-w-5xl mx-auto">
            <h2 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black text-white tracking-tighter mb-10 leading-[0.95]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 xl:grid-cols-5 gap-6">
            {[
              ...
              { title: "Education", desc: "Talent solutions for education providers, EdTech companies, academic institutions, administration, and instructional support teams." },
          ...
          <div className="flex flex-col lg:flex-row items-start gap-8 xl:gap-12 lg:gap-10 xl:gap-16 2xl:gap-24">
            ...
            <div className="lg:w-1/2 grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                ...
                {
                  title: "Candidate Experience That Reflects Your Brand",
      ...
      <section className="bg-navy-dark py-20 lg:py-24 2xl:py-32 relative overflow-hidden border-b border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-24 max-w-5xl mx-auto">
            <h2 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black text-white tracking-tighter leading-[0.95] mb-10">
      ...
      <section className="relative py-24 lg:py-32 2xl:py-48 px-4 overflow-hidden bg-navy-dark border-t border-white/5">
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center space-y-16">
          <div className="space-y-8">
            <h2 className="text-4xl md:text-6xl lg:text-7xl 2xl:text-8xl font-black text-white tracking-tighter leading-[0.9] drop-shadow-2xl">
