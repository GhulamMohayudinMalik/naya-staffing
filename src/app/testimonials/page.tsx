    ...
    <div className="min-h-screen bg-navy-dark flex flex-col font-sans selection:bg-gold selection:text-navy-dark overflow-x-hidden">
      ...
      <section className="relative h-[75vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 text-center px-4 max-w-5xl space-y-8 animate-fade-up">
          ...
          <h1 className="text-4xl md:text-5xl xl:text-7xl lg:text-8xl font-black text-white tracking-tighter leading-[0.85] drop-shadow-2xl">
            <Typewriter>
      ...
      <main className="max-w-full py-32 space-y-40">
        ...
        <section className="space-y-20">
          <div className="container mx-auto px-4 text-center space-y-6">
            <h6 className="btn-rotating-border text-gold font-black uppercase tracking-[0.4em] text-xs mb-6 px-4 py-1 bg-white/5 inline-block rounded-full border border-gold/10 btn-auto-sheen border border-white/5">Enterprise Feedback</h6>
            ...
            <div className="btn-rotating-border h-1 w-24 bg-white/5 mx-auto rounded-full opacity-50 btn-auto-sheen border border-white/5"></div>
          </div>

          <div className="relative overflow-hidden marquee-mask group">
            <div className="animate-marquee gap-6 xl:gap-10 py-10">
              {[...clientTestimonials, ...clientTestimonials, ...clientTestimonials].map((t, i) => (
                <div key={i} className="w-[450px] flex-shrink-0">
                  <div className="glass-panel p-16 rounded-[64px] border-white/5 flex flex-col h-full hover:border-gold/30 hover:shadow-gold/5 transition-all duration-700 bg-navy/30">
                    <div className="btn-rotating-border w-16 h-1 bg-white/20 mb-10 group-hover:bg-white/5 transition-all duration-700 rounded-full btn-auto-sheen border border-white/5"></div>
                    <div className="grow">
        ...
        <section className="space-y-20">
          <div className="container mx-auto px-4 text-center space-y-6">
            <h6 className="btn-rotating-border text-gold font-black uppercase tracking-[0.4em] text-xs mb-6 px-4 py-1 bg-white/5 inline-block rounded-full border border-gold/10 btn-auto-sheen border border-white/5">Candidate Journey</h6>
          ...
          <div className="relative overflow-hidden marquee-mask group">
            <div className="animate-marquee-reverse gap-6 xl:gap-10 py-10">
              {[...candidateTestimonials, ...candidateTestimonials, ...candidateTestimonials].map((t, i) => (
                <div key={i} className="w-[450px] flex-shrink-0">
                  <div className="btn-rotating-border glass-panel p-16 rounded-[64px] border-white/5 flex flex-col h-full hover:border-gold/30 hover:shadow-gold/5 transition-all duration-700 bg-white/5 btn-auto-sheen">
                    <div className="btn-rotating-border w-16 h-1 bg-white/5 mb-10 group-hover:scale-x-150 transition-all duration-700 rounded-full btn-auto-sheen border border-white/5"></div>
                    <div className="grow">
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="glass-panel rounded-[64px] p-20 text-center space-y-12 border-white/5 relative overflow-hidden bg-navy">
                ...
                <h2 className="text-4xl md:text-5xl xl:text-7xl lg:text-8xl font-black text-white tracking-tighter relative z-10 leading-none">Ready to be <br /> <span className="text-shimmer">Next?</span></h2>
                ...
                <div className="flex flex-col sm:flex-row gap-6 xl:gap-8 justify-center pt-8 relative z-10">
                    ...
                    <Link href="/register-upload-resume" className="bg-white/5 hover:bg-white/10 text-white border-2 border-white/10 px-16 py-6 rounded-full font-black text-xs uppercase tracking-[0.4em] transition-all flex items-center justify-center gap-4 backdrop-blur-md btn-sheen">
