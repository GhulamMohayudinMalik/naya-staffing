            ...
            <div className="relative group order-1 lg:order-2">
              <div className="relative rounded-[80px] overflow-hidden p-6 glass-panel border-white/10 shadow-2xl">
                <div className="rounded-[60px] overflow-hidden relative aspect-[4/5] md:aspect-square">
                   <img 
                    src="https://nayastaffing.com/wp-content/uploads/2024/12/1-8.jpg" 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            ...
            <div className="relative group">
              <div className="relative rounded-[80px] overflow-hidden p-6 glass-panel border-white/10 shadow-2xl">
                <img 
                  src="https://nayastaffing.com/wp-content/uploads/2025/05/1-2.jpg" 
      ...
      <section className="bg-navy-dark pb-32 overflow-hidden border-t border-white/5">
        ...
        <div className="relative">
          ...
          <div className="animate-marquee-emp gap-10">
            {[
              { title: "Information Technology", image: "https://nayastaffing.com/wp-content/uploads/2025/02/tech-talent.jpg" },
              { title: "Healthcare", image: "https://nayastaffing.com/wp-content/uploads/2024/10/Healthcare.jpg" },
              { title: "Industrial", image: "https://nayastaffing.com/wp-content/uploads/2025/05/1-1.jpg" },
              { title: "Hospitality", image: "https://nayastaffing.com/wp-content/uploads/2024/10/Senior-Living.jpg" },
              { title: "Insurance", image: "https://nayastaffing.com/wp-content/uploads/2025/05/Education-Recruitment-Agency-in-Pakistan.png" },
              { title: "Marketing", image: "https://nayastaffing.com/wp-content/uploads/2025/05/employer-top-image.jpeg" }
            ].concat([
              { title: "Information Technology", image: "https://nayastaffing.com/wp-content/uploads/2025/02/tech-talent.jpg" },
              { title: "Healthcare", image: "https://nayastaffing.com/wp-content/uploads/2024/10/Healthcare.jpg" }
            ]).map((ind, idx) => (
