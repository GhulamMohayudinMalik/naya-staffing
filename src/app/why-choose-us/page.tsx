    ...
    <div className="min-h-screen bg-navy-dark flex flex-col font-sans selection:bg-gold selection:text-navy-dark overflow-x-hidden">
      ...
      <section className="relative h-[70vh] flex flex-col items-center justify-center overflow-hidden pt-20">
        <div className="absolute inset-0 z-0">
          <img 
            src="https://nayastaffing.com/wp-content/uploads/2025/05/1-1-1024x683.jpg" 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
             <div className="relative group lg:order-2">
              <div className="relative rounded-[80px] overflow-hidden p-6 glass-panel border-white/10 shadow-2xl">
                <div className="rounded-[60px] overflow-hidden relative aspect-[4/5] md:aspect-square">
                   <img 
                    src="https://nayastaffing.com/wp-content/uploads/2025/05/employer-top-image.jpeg.webp" 
                    alt="Strategic Edge" 
        ...
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {[
              ...
              { title: "Direct Hire", icon: Navigation, href: "/permanent-recruitment", desc: "Long-term placements that align with your corporate DNA." },
              { title: "Contract to Hire", icon: Layers, href: "/contract-staffing", desc: "Evaluate talent in action before making a permanent hire." },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            ...
            <div className="relative group">
               <div className="relative rounded-[80px] overflow-hidden p-6 glass-panel border-white/10 shadow-2xl">
                <img 
                  src="https://nayastaffing.com/wp-content/uploads/2025/05/tmi-tetains-the-recruiters.jpg.webp" 
