        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 xl:gap-8">
            {data.subIndustries.map((sub) => (
              ...
              >
                <div className="btn-rotating-border w-12 h-12 rounded-2xl bg-white/10 text-gold flex items-center justify-center mb-6 group-hover:scale-110 transition-transform btn-auto-sheen border border-white/5">
